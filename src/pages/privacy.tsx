...
const Privacy: NextPage = () => {
  return (
    <>
      <Container>
        <Text h1>PRIVACY NOTICE</Text>
        This privacy notice for UTOKER CORP. (&quot;Company,&quot;
        ...
        as when you: Visit our website at http://albertsolver.com, or any
        ...
        questions or concerns, please contact us at hello@albertsolver.com.
        {/* <Text h2>SUMMARY OF KEY POINTS</Text>
      <Text>
        ...
        information depending on how you interact with UTOKER CORP. and the
        ...
        parties. Click here to learn more. How do we keep your information safe?
        ...
        modify your information. Click here to learn more. What are your rights?
        ...
        protection laws. Want to learn more about what UTOKER CORP. does with
        any information we collect? Click here to review the notice in full.
      </Text> */}
        <Text h2> 1. WHAT INFORMATION DO WE COLLECT?</Text>
        <Text h3> Personal information you disclose to us</Text>
        <Text>
          ...
          include the following: names email addresses debit/credit card numbers
          billing addresses contact or authentication data Sensitive
          ...
          https://stripe.com/privacy. Social Media Login Data. We may provide
          ...
          media account. If you choose to register in this way, we will collect
          the information described in the section called &quot;HOW DO WE HANDLE
          YOUR SOCIAL LOGINS?&quot; below. All personal information that you
          provide to us must be true, complete, and accurate, and you must
          notify us of any changes to such personal information.
        </Text>
        <Text h3> Information automatically collected</Text>
        <Text>
          ...
          called &quot;crash dumps&quot;), and hardware settings). Device Data.
        ...
        <Text h2> 2. HOW DO WE PROCESS YOUR INFORMATION?</Text>
        <Text>
          ...
          interact with our Services, including: To facilitate account creation
          and authentication and otherwise manage user accounts. We may process
          your information so you can create and log in to your account, as well
          as keep your account in working order. To save or protect an
        ...
        {/* Click
      <a href="https://app.termly.io/builder/websites/bd383534-1d9b-4b3f-9312-fdce82c925d7/documents/2574849/Final%20Details/Version%20Date#withdrawconsent">
        here
      </a>
      to learn more.  */}
        ...
        involving potential threats to the safety of any person. If you are
      ...
      to learn more.  */}
        ...
        example: If collection is clearly in the interests of an individual and
        consent cannot be obtained in a timely way For investigations and fraud
        ...
        <Text h2> 5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</Text>
        <Text>
          ...
          on our Services, but are not affiliated with, our Services. The
          ...
          or applications. Accordingly, we do not make any guarantee regarding
          any such third parties, and we will not be liable for any loss or
        ...
        <Text h2>6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</Text>
        <Text>
        ...
        <Text h2>7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</Text>
        <Text>
        ...
        <Text h2>8. HOW LONG DO WE KEEP YOUR INFORMATION?</Text>
        <Text>
        ...
        <Text h2>9. HOW DO WE KEEP YOUR INFORMATION SAFE?</Text>
        <Text>
        ...
        <Text h2>10. DO WE COLLECT INFORMATION FROM MINORS?</Text>
        <Text>
          ...
          hello@albertsolver.com.
        </Text>
        <Text h2>11. WHAT ARE YOUR PRIVACY RIGHTS?</Text>
        <Text>
        ...
        <Text>
          ...
          about your privacy rights, you may email us at hello@albertsolver.com.
        </Text>
        <Text h2>12. CONTROLS FOR DO-NOT-TRACK FEATURES</Text>
        <Text>
        ...
        <Text h3>CCPA Privacy Notice</Text>
        <Text>
          {' '}
          ...
          are defined as &quot;non-residents.&quot; If this definition of
          &quot;resident&quot; applies to you, we must adhere to certain rights
          and obligations regarding your personal information. What categories
          of personal information do we collect? We have collected the following
          ...
          address, email address, and account name YES B. Personal information
          ...
          financial information YES C. Protected classification characteristics
          under California or federal law Gender and date of birth YES D.
          Commercial information Transaction information, purchase history,
          financial details, and payment information YES E. Biometric
          ...
          applications, systems, and advertisements YES G. Geolocation data
          Device location YES H. Audio, electronic, visual, thermal, olfactory,
          or similar information Images and audio, video or call recordings
          created in connection with our business activities YES I. Professional
          or employment-related information Business contact details in order to
          ...
          information YES K. Inferences drawn from other personal information
          ...
          individual&apos;s preferences and characteristics YES L. Sensitive
          Personal Information NO We will use and retain the collected personal
          information as needed to provide the Services or for: Category A - As
          long as the user has an account with us Category B - As long as the
          user has an account with us Category C - As long as the user has an
          account with us Category D - As long as the user has an account with
          us Category F - As long as the user has an account with us Category G
          - As long as the user has an account with us Category H - As long as
          the user has an account with us Category J - As long as the user has
          an account with us Category K - As long as the user has an account
          with us We may also collect other personal information outside of
          these categories through instances where you interact with us in
          ...
          and to respond to your inquiries. How do we use and share your
          personal information? More information about our data collection and
          sharing practices can be found in this privacy notice. You may contact
          us by email at hello@albertsolver.com, or by referring to the contact
          ...
          privacy protection obligations mandated by the CCPA. We may use your
          ...
          your personal information. UTOKER CORP. has not disclosed, sold, or
          shared any personal information to third parties for a business or
          commercial purpose in the preceding twelve (12) months. UTOKER CORP.
          will not sell or share personal information in the future belonging to
          website visitors, users, and other consumers. Your rights with respect
          to your personal data Right to request deletion of the data — Request
          ...
          may be required to protect against illegal activities. Right to be
          informed — Request to know Depending on the circumstances, you have a
          right to know: whether we collect and use your personal information;
          the categories of personal information that we collect; the purposes
          for which the collected personal information is used; whether we sell
          or share personal information to third parties; the categories of
          ...
          we collected about you. In accordance with applicable law, we are not
          ...
          privacy rights. Right to Limit Use and Disclosure of Sensitive
          Personal Information We do not process consumer&apos;s sensitive
          personal information. Verification process Upon receiving your
          ...
          For instance, depending on the type of request you submit, we may ask
          you to provide certain information so that we can match the
          information you provide with the information we already have on file,
          or we may contact you through a communication method (e.g., phone or
          ...
          hello@albertsolver.com, or by referring to the contact details at the
          bottom of this document. If you have a complaint about how we handle
          your data, we would like to hear from you.
        </Text>
        <Text h2>14. DO WE MAKE UPDATES TO THIS NOTICE?</Text>
        <Text>
        ...
        <Text h2>15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Text>
        <Text>
          If you have questions or comments about this notice, you may email us
          at hello@albertsolver.com or by post to: UTOKER CORP. 67 Pinewoods
          cres, Middle Island, NY,11953 Middle Island, NY 11953 United States
        </Text>
        <Text h2>
        ...
        <Text>
          ...
          clicking
          <a href="https://app.termly.io/notify/b412b50d-034f-4ce1-86c3-7efa7d5fe241">
            here.
          </a>
        </Text>
      </Container>
