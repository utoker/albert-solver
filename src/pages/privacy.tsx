...
const Privacy: NextPage = () => {
  return (
    <Container>
      ...
      This privacy notice for UTOKER CORP. (&quot;Company,&quot; &quot;we,&quot;
      ...
      our website at http://albertsolver.com, or any website of ours that links
      to this privacy notice Engage with us in other related ways, including any
      sales, marketing, or events Questions or concerns? Reading this privacy
      ...
      <Text>
        ...
        personal information we collect may include the following: names email
        addresses debit/credit card numbers billing addresses contact or
        authentication data Sensitive Information. We do not process sensitive
        ...
        link(s) here: https://stripe.com/privacy. Social Media Login Data. We
      ...
      <Text>
        ...
        system, and system configuration information. Location Data. We collect
        ...
        the Services. For example, we may use GPS and other technologies to
      ...
      <Text>
        ...
        keep your account in working order. To save or protect an
      ...
      you. The General Data Protection Regulation (GDPR) and UK GDPR require us
      ...
      which we are involved. Vital Interests. We may process your information
      ...
      section applies to you. We may process your information if you have given
      us specific permission (i.e., express consent) to use your personal
      information for a specific purpose, or in situations where your permission
      can be inferred (i.e., implied consent). You can withdraw your consent at
      any time.
      {/* Click
      <a href="https://app.termly.io/builder/websites/bd383534-1d9b-4b3f-9312-fdce82c925d7/documents/2574849/Final%20Details/Version%20Date#withdrawconsent">
        here
      ...
      required to comply with a subpoena, warrant, court order, or rules of the
      court relating to the production of records If it was produced by an
      ...
      was produced If the collection is solely for journalistic, artistic, or
      ...
      <Text>
        ...
        Services, but are not affiliated with, our Services. The Services may
        link to third-party websites, online services, or mobile applications
      ...
      <Text>
        ...
        age 18, please contact us at hello@albertsolver.com.
      </Text>
      ...
      <Text>
        ...
        change, or terminate your account at any time. In some regions (like the
        EEA, UK, and Canada), you have certain rights under applicable data
        ...
        consider and act upon any request in accordance with applicable data
        protection laws. If you are located in the EEA or UK and you believe we
      ...
      <Text h2>13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</Text>
      <Text>
      ...
      <Text>
        ...
        and obligations regarding your personal information. What categories of
        ...
        other websites, applications, systems, and advertisements YES G.
        Geolocation data Device location YES H. Audio, electronic, visual,
        ...
        long as the user has an account with us Category B - As long as the user
        has an account with us Category C - As long as the user has an account
        with us Category D - As long as the user has an account with us Category
        F - As long as the user has an account with us Category G - As long as
        the user has an account with us Category H - As long as the user has an
        account with us Category J - As long as the user has an account with us
        Category K - As long as the user has an account with us We may also
        ...
        to be &quot;selling&quot; of your personal information. UTOKER CORP. has
        not disclosed, sold, or shared any personal information to third parties
        for a business or commercial purpose in the preceding twelve (12)
        months. UTOKER CORP. will not sell or share personal information in the
        ...
        rights. Right to Limit Use and Disclosure of Sensitive Personal
        Information We do not process consumer&apos;s sensitive personal
        information. Verification process Upon receiving your request, we will
        need to verify your identity to determine you are the same person about
        whom we have the information in our system. These verification efforts
        ...
        the circumstances dictate. We will only use personal information
        provided in your request to verify your identity or authority to make
        the request. To the extent possible, we will avoid requesting additional
        information from you for the purposes of verification. However, if we
        ...
        purposes. We will delete such additionally provided information as soon
        as we finish verifying you. Other privacy rights You may object to the
        processing of your personal information. You may request correction of
        your personal data if it is incorrect or no longer relevant, or ask to
        restrict the processing of the information. You can designate an
        ...
        with the CCPA. You may request to opt out from future selling or sharing
      ...
      <Text>
        ...
        privacy notice frequently to be informed of how we are protecting yo
      </Text>
      <Text h2>15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Text>
      <Text>
        If you have questions or comments about this notice, you may email us at
        hello@albertsolver.com or by post to: UTOKER CORP. 67 Pinewoods cres,
        Middle Island, NY,11953 Middle Island, NY 11953 United States
      </Text>
      <Text h2>
