...
const Privacy: NextPage = () => {
  return (
    <Container>
      <Text h1>UTOKER CORP. Privacy Policy </Text>
      This Privacy Policy describes how your personal information is collected,
      used, and shared when you visit or make a purchase from albertsolver.com
      (the “Site”).
      <Text h2>PERSONAL INFORMATION WE COLLECT</Text>
      <Text>
      ...
      <Text h2> HOW DO WE USE YOUR PERSONAL INFORMATION?</Text>
      <Text>
        {' '}
      ...
      <Text h2> SHARING YOUR PERSONAL INFORMATION</Text>
      <Text>
        We share your Personal Information with third parties to help us use
        your Personal Information, as described above. For example, we use
        Stripe to power our payment--you can read more about how Stripe uses
        your Personal Information here: https://stripe.com/privacy We also use
      ...
      <Text h2>DO NOT TRACK</Text> Please note that we do not alter our Site’s
      data collection and use practices when we see a Do Not Track signal from
      your browser.<Text h2> YOUR RIGHTS</Text> If you are a European resident,
      you have the right to access personal information we hold about you and to
      ...
      contact information below. Additionally, if you are a European resident we
      note that we are processing your information in order to fulfill contracts
      we might have with you (for example if you make an order through the
      Site), or otherwise to pursue our legitimate business interests listed
      above. Additionally, please note that your information will be transferred
      outside of Europe, including to Canada and the United States.{' '}
      <Text h2>DATA RETENTION</Text> When you place an order through the Site,
      we will maintain your Order Information for our records unless and until
      you ask us to delete this information. <Text h2>MINORS</Text> The Site is
      not intended for individuals under the age of 18. <Text h2>CHANGES</Text>{' '}
      ...
      <Text>
        ...
        hello@albertsolver.com or by mail using the details provided below: 67
        Pinewoods Crescent, Middle Island, NY, 11953, United States
      </Text>
    </Container>
  );
};
