...
const Terms: NextPage = () => {
  return (
    <Container>
      ...
      <Text>
        This website is operated by UTOKER CORP.. Throughout the site, the terms
        “we”, “us” and “our” refer to UTOKER CORP.. UTOKER CORP. offers this
      ...
      <Text h2>SECTION 1 - ONLINE STORE TERMS</Text>{' '}
      <Text>
        {' '}
      ...
      <Text h2>SECTION 2 - GENERAL CONDITIONS </Text>
      <Text>
      ...
      <Text h2> SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</Text>{' '}
      <Text>
      ...
      <Text h2> SECTION 7 - OPTIONAL TOOLS</Text>{' '}
      <Text>
      ...
      <Text h2>SECTION 8 - THIRD-PARTY LINKS</Text>{' '}
      <Text>
      ...
      <Text h2>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</Text>{' '}
      <Text>
      ...
      <Text h2>SECTION 10 - PERSONAL INFORMATION </Text>{' '}
      <Text>
        {' '}
      ...
      <Text h2>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS </Text>{' '}
      <Text>
      ...
      <Text h2>SECTION 12 - PROHIBITED USES </Text>{' '}
      <Text>
        {' '}
      ...
      <Text>
        ...
        non-infringement. In no case shall UTOKER CORP., our directors,
      ...
      <Text h2> SECTION 14 - INDEMNIFICATION </Text>
      <Text>
        You agree to indemnify, defend and hold harmless UTOKER CORP. and our
      ...
      <Text h2>SECTION 15 - SEVERABILITY </Text>
      <Text>
      ...
      <Text h2>SECTION 16 - TERMINATION </Text>The obligations and liabilities
      of the parties incurred prior to the termination date shall survive the
      termination of this agreement for all purposes. These Terms of Service are
      ...
      our sole judgment you fail, or we suspect that you have failed, to comply
      ...
      thereof).
      <Text h2> SECTION 17 - ENTIRE AGREEMENT</Text>
      <Text>
      ...
      <Text h2> SECTION 18 - GOVERNING LAW </Text>{' '}
      <Text>
        {' '}
      ...
      <Text h2> SECTION 19 - CHANGES TO TERMS OF SERVICE</Text>{' '}
      <Text>
        {' '}
